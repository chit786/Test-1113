...
// Date created:         Fri Jun 08 09:50:43 CEST 2018
    ...
    phases {
      ...
      phase('New Phase') {
        tasks {
          ...
          manual('T2') {
            failureHandler 'sadsafdvasdg wrG A G AEG \n' +
                           's\n' +
                           ' daegea'
            failureHandlerScriptEnabled true
            taskRecoverOp com.xebialabs.xlrelease.domain.recover.TaskRecoverOp.FAIL_TASK
          }
          manual('T3') {
